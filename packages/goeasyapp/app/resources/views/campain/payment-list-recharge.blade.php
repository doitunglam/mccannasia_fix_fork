                                ...
                                <div class="">
                                        ...
                                        @if($config != NULL)
                                            @foreach( $config as $index => $n)
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <p class="mb-4" style="margin-bottom: 9px !important;font-weight: bold">{{__trans($language, 'All.bank_account', 'Số tài khoản')}}:
                                                        <span class="text-primary">{!!__transItem($n->value)!!}</span>
                                                    </p>
                                                    <p class="mb-4" style="margin-bottom: 9px !important;font-weight: bold">{{ 'Nội dung chuyển khoản' }}:
                                                        <span class="text-primary">{!!$info['name']!!}</span></p>
                                    ...
                                    @else
                                        <div class="mb-3">
                                            ...
                                            <p class="mb-4" style="margin-bottom: 9px !important;font-weight: bold">{{__trans($language, 'All.bank_account', 'Số tài khoản')}}:
                                                <span class="text-primary">{!!$user->bank_account!!}</span></p>
                                        </div>
                                    @endif
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control s_name" id="reason" placeholder="" name="reason" value="{{request()->reason}}" rows="6"></textarea>
                                    </div>
                                </div>
                                @if($type == 1)
                                    ...
                                    <tr data-id="1" style="cursor: pointer;">
                                        @foreach($td as $i)
                                            ...
                                            @if(isset($i['type']) && $i['type'] == 'image')
                                                <td style="">
                                                    <img style="height: 150px; width: auto" src="{!! env('APP_URL').__transItem($item->$key) !!}"/>
                                                </td>
                                            @else
                                        ...
                                        @if($item->type == '')
                                            <td data-field="name" style="width: 50px;">
                                                <span class="badge rounded-pill badge-soft-success">{{__trans($language, 'All.withdraw_money', 'Withdraw Money')}}</span>
                                            </td>
                                        @else
                                            <td data-field="name" style="width: 50px;">
                                                <span class="badge rounded-pill badge-soft-danger">{{__trans($language, 'All.recharge', 'Recharge')}}</span>
                                            </td>
                                        @endif
