            ...
            <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <div class="col-sm-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control s_name" id="name" placeholder=""
                                    name="s_name" value="{{ request()->s_name }}">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-danger waves-effect waves-light"
                            style="height: 36px;margin-top: 26px;"
                            onclick="return confirm('{{ __trans($language, 'All.confirm_payment_recharge', 'Bạn chắc chắn thực hiện điều này?') }}')">{{ __trans($language, 'All.search', 'Tìm kiếm') }}</button>
                ...
                <div class="d-flex flex-wrap gap-2" style="margin-top: -77px;">
                    ...
                    <div class="col-sm-2"> <button type="button"
                            class="btn btn-primary waves-effect waves-light get-download"
                            style="height: 36px;margin-top: 23px;margin-left: 79px;position: relative;z-index: 10;"
                            onclick="return confirm('{{ __trans($language, 'All.confirm_payment_recharge', 'Bạn chắc chắn thực hiện điều này?') }}')">{{ __trans($language, 'All.export', 'Xuất') }}</button>
                    </div>
                </div>
                <a class="btn btn-success waves-effect waves-light mt-3" href="{{ route('payment.acceptAll', $type) }}"
                    onclick="return confirm('{{ __trans($language, 'All.confirm_payment_recharge', 'Bạn chắc chắn thực hiện điều này?') }}')">{{ __trans($language, 'All.accept', 'Chấp nhận tất cả yêu cầu') }}</a>
            </div>
