...
<body
    ...
    <div class="wp-site-blocks">
        ...
        <p class="has-text-align-center font-lato" style="font-size:35px"> <strong>VĂN PHÒNG</strong> <br>
            <strong><span style="color: #ff7e02;">MCCANNASIA VIỆT NAM</span></strong> </p>
                ...
                <div class="is-layout-flow wp-block-column">
                    <div class="is-layout-constrained wp-container-7 wp-block-group">
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="800"
                                height="549" src="./images/2023-03-1104_nha-tho-duc-ba-sai-gon-1.jpg"
                                alt="" class="wp-image-564" /></figure>
                    </div>
                    <p class="font-lato" style="font-size:15px;text-decoration:underline">TRỤ SỞ CHÍNH</p>
                    <p class="font-lato" style="font-size:15px">Lầu 3, tòa nhà Viet Solutions, số 125/11 Nguyễn Cửu
                        Vân,
