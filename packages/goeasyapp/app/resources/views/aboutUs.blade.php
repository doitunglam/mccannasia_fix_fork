...
<head>
    ...
    <link rel="canonical" href="{{ route('home.aboutUs') }}" />
    ...
    <script>
        _N2.r('documentReady', function() {
            _N2.r(["documentReady", "smartslider-frontend", "SmartSliderWidgetArrowImage", "ss-simple"],
                function() {
...
@endif
    ...
    <div class="wp-site-blocks">
        ...
        <div class="wp-block-cover"><span aria-hidden="true"
                ...
                style="background-color:#606060"></span><img decoding="async" loading="lazy" width="1894"
                height="800" class="wp-block-cover__image-background wp-image-399" alt=""
                    ...
                    <div class="is-layout-flow wp-container-8 wp-block-column">
                        <div class="is-layout-constrained wp-container-7 wp-block-group">
                            <figure class="wp-block-image size-full is-resized is-style-default style-svg"><img
                                    decoding="async" loading="lazy" src="./images/2023-03-about-us-1-1.svg"
                                    alt="" class="wp-image-531" width="113" height="113" /></figure>
                        </div>
                    ...
                    <div class="is-layout-flow wp-container-10 wp-block-column">
                        <div class="is-layout-constrained wp-container-9 wp-block-group">
                            <figure class="wp-block-image alignwide size-large is-style-default style-svg"><img
                                    decoding="async" src="./images/2023-02-4.svg" alt=""
                                    class="wp-image-156" />
                            </figure>
                        </div>
                        <p class="has-text-align-center font-lato has-background-color has-text-color"
                ...
                <div class="is-layout-flex wp-container-18 wp-block-columns">
                    <div class="is-layout-flow wp-container-13 wp-block-column">
                        <div class="is-layout-constrained wp-container-12 wp-block-group">
                            <figure class="wp-block-image alignwide size-large is-style-default style-svg"><img
                                    decoding="async" src="./images/2023-02-5.svg" alt=""
                                    class="wp-image-157" />
                            </figure>
                        </div>
                        <p class="has-text-align-center font-lato has-background-color has-text-color"
                    ...
                    <div class="is-layout-flow wp-container-17 wp-block-column">
                        <div class="is-layout-constrained wp-container-16 wp-block-group">
                            <figure class="wp-block-image alignwide size-large is-style-default style-svg"><img
                                    decoding="async" src="./images/2023-02-2-1.svg" alt=""
                                    class="wp-image-153" />
                            </figure>
                        </div>
                        <p class="has-text-align-center font-lato has-background-color has-text-color"
        ...
        <div class="is-layout-flex wp-container-27 wp-block-columns">
            <div class="is-layout-flow wp-block-column">
                ...
                <p class="has-text-align-center font-be has-text-color" style="color:#121313;font-size:15px">Tạo ra
                    hàng
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-constrained wp-container-21 wp-block-group">
                    <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="256"
                            height="256" src="./images/2023-03-53421_orange_256x256.png" alt=""
                            class="wp-image-544" />
                    </figure>
                </div>
                <p class="has-text-align-center font-be has-text-color" style="color:#121313;font-size:15px">Tạo ra
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-constrained wp-container-23 wp-block-group">
                    <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="180"
                            height="180" src="./images/2023-03-icon-welfare-17.png" alt=""
                            class="wp-image-545" />
                    </figure>
                </div>
                <p class="has-text-align-center font-be has-text-color" style="color:#121313;font-size:15px">Giúp
                    người
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-constrained wp-container-25 wp-block-group">
                    <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="452"
                            height="452" src="./images/2023-03-account-3d.png" alt=""
                            class="wp-image-546" /></figure>
                </div>
        ...
        <div class="wp-block-nextend-smartslider3">
            <div class="n2_clear">
                <ss3-force-full-width data-overflow-x="body" data-horizontal-selector="">
                    <div class="n2-section-smartslider fitvidsignore  n2_clear" data-ssid="7" tabindex="0"
                                    ...
                                    <div class="n2-ss-slider-wrapper-inside">
                                        ...
                                        <div class="n2-ss-slider-controls n2-ss-slider-controls-absolute-left-center">
                                            <div style="--widget-offset:15px;"
                                                ...
                                                data-hide-mobileportrait="1" id="n2-ss-7-arrow-previous"
