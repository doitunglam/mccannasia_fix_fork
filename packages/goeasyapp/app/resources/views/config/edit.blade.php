                                ...
                                <div class="col-12">
                                    <div class="row show-html">
                                        ...
                                        <div class="col-9">  
                                            ...
                                            <x-component::form.text name="name[bank]" default="Bank Name" value="{{$array['bank']}}" id="link" key="all.bank_name" placeholder="All.enter_bank_name" defaultplaceholder="Enter your name"/>
