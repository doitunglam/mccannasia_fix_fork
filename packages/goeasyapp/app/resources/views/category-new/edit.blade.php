                ...
                <div class="tab-content p-3 text-muted">
                    ...
                    <div class="tab-pane{{($index == 0) ? ' active show': ''}}" id="{{$ln->code}}" role="tabpanel">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-9">
                                    <x-component::form.text name="name[{{$ln->code}}]" default="Name" value="{{json($item->name)[$ln->code]}}" id="name" key="all.name" placeholder="All.enter_name" defaultplaceholder="Nhập tên"/>
                                    <x-component::input.ckeditor name="description[{{$ln->code}}]" default="Description" value="{{json($item->description)[$ln->code]}}" id="description" key="All.description" placeholder="All.enter_description" defaultplaceholder="Nhập mô tả"/>
                                </div>
                                <div class="col-3">
