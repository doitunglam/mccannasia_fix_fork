...
<body
    ...
    <div class="wp-site-blocks">
        ...
        <div class="is-layout-flow entry-content wp-block-post-content">
                ...
                <nav>
                    <ul class='ez-toc-list ez-toc-list-level-1'>
                        ...
                        <li class='ez-toc-page-1 ez-toc-heading-level-3'><a class="ez-toc-link ez-toc-heading-5"
                                href="#5_Nghiem_cam_reseller" title="5. Nghiêm cấm reseller">5. Nghiêm cấm
                                reseller</a>
                        </li>
            ...
            <p style="font-size:16px">Hành vi chạy từ khóa thương hiệu hoặc sử dụng từ khóa cố tình viết sai thương
                hiệu
            ...
            <h3 style="font-size:18px"><span class="ez-toc-section"
                    id="3_Nghiem_cam_co_tinh_gian_lan_lam_gia_thong_tin_nguoi_dung"></span><strong>3. Nghiêm cấm cố
                    tình
            ...
            <h3 style="font-size:18px"><span class="ez-toc-section" id="5_Nghiem_cam_reseller"></span><strong>5.
                    Nghiêm
            ...
            <p style="font-size:16px">VD: Cố tình viết thiếu, viết ấn dụ, nói quá các chương trình của nhà cung cấp
                nhằm
                    ...
                    <nav class='ez-toc-sticky-toggle-direction'>
                        <ul class='ez-toc-sticky-list ez-toc-sticky-list-level-1'>
                            ...
                            <li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
                                    ...
                                    href="#3_Nghiem_cam_co_tinh_gian_lan_lam_gia_thong_tin_nguoi_dung"
                                    title="3. Nghiêm cấm cố tình gian lận làm giả thông tin người dùng">3. Nghiêm cấm
                                    cố
                                    tình gian lận làm giả thông tin người dùng</a></li>
                            <li class='ez-toc-sticky-page-1 ez-toc-sticky-heading-level-3'><a
    ...
    <script src='./js/easy-table-of-contents-vendor-sticky-kit-jquery.sticky-kit.min.js' id='ez-toc-jquery-sticky-kit-js'>
    </script>
