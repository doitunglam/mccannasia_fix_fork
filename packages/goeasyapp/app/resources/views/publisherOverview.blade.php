...
<head>
    ...
    <script>
        window._wpemojiSettings = {
            ...
            "svgExt": ".svg",
            "source": {
                "concatemoji": "http:\/\/localhost\/wordpress\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.1.1"
            }
        };
    ...
    <link rel='stylesheet' id='ez-toc-css' href='./css/easy-table-of-contents-assets-css-screen.min.css'
        media='all' />
    ...
    <link rel='stylesheet' id='elementor-frontend-css' href='./css/elementor-assets-css-frontend-lite.min.css'
        media='all' />
    <link rel='stylesheet' id='swiper-css' href='./css/elementor-assets-lib-swiper-v8-css-swiper.min.css'
        media='all' />
    ...
    <link rel='stylesheet' id='popup-maker-site-css' href='./css/popup-maker-assets-css-pum-site.min.css'
        media='all' />
        ...
        jQuery(document).ready(function() {
            document.querySelectorAll(".ez-toc-section").forEach(t => {
                ...
                let t = jQuery(this).attr("href"),
                    e = jQuery("#wpadminbar"),
                    i = 0;
                30 > 30 && (i = 30), e.length && (i += e.height()), jQuery('[ez-toc-data-id="' + decodeURI(
                    t) + '"]').length > 0 && (i = jQuery('[ez-toc-data-id="' + decodeURI(t) + '"]')
                    .offset().top - i), jQuery("html, body").animate({
                    scrollTop: i
                }, 500)
            })
        });
    ...
    <link rel="EditURI" type="application/rsd+xml" title="RSD"
        href="http://localhost/wordpress/xmlrpc.php?rsd" />
    ...
    <meta name="msapplication-TileImage"
        content="http://localhost/wordpress/wp-content/uploads/2023/03/lllll-1.png" />
    ...
    <script src="./js/smart-slider-3-Public-SmartSlider3-Application-Frontend-Assets-dist-smartslider-frontend.min.js" defer
        async></script>
    <script src="./js/smart-slider-3-Public-SmartSlider3-Slider-SliderType-Simple-Assets-dist-ss-simple.min.js" defer async>
    </script>
    ...
    <script>
        _N2.r('documentReady', function() {
            _N2.r(["documentReady", "smartslider-frontend", "SmartSliderWidgetArrowImage",
                "SmartSliderWidgetBulletTransition", "ss-simple"
            ], function() {
...
<body
    ...
    <div class="wp-site-blocks">
                ...
                <div class="is-layout-flex wp-block-group">
                    <div class="is-layout-constrained wp-container-1 wp-block-group">
                        <figure class="wp-block-image size-full is-resized"><a href="{{ route('home.base') }}"><img
                                    decoding="async" loading="lazy" src="./images/LOGO1.png" alt=""
        ...
        <div class="wp-block-nextend-smartslider3">
            <div class="n2_clear">
                <ss3-force-full-width data-overflow-x="body" data-horizontal-selector="">
                    <div class="n2-section-smartslider fitvidsignore  n2_clear" data-ssid="6" tabindex="0"
                                    ...
                                    <div class="n2-ss-slider-wrapper-inside">
                                                    ...
                                                    <div class="n2-ss-slide-backgrounds n2-ow-all">
                                                        <div class="n2-ss-slide-background" data-public-id="1"
                                                            ...
                                                            <div class="n2-ss-slide-background-image" data-blur="0"
                                                                data-opacity="100" data-x="50" data-y="50"
                                                                data-alt="" data-title="">
                                                        ...
                                                        <div class="n2-ss-slide-background" data-public-id="2"
                                                            data-mode="fill">
                                                            <div class="n2-ss-slide-background-image" data-blur="0"
                                                                data-opacity="100" data-x="0" data-y="43"
                                                                data-alt="" data-title=""
                                                                style="--ss-o-pos-x:0%;--ss-o-pos-y:43%">
                                                                <picture class="skip-lazy" data-skip-lazy="1"><img
                                        ...
                                        <div class="n2-ss-slider-controls n2-ss-slider-controls-absolute-left-center">
                                            <div style="--widget-offset:15px;"
                                                ...
                                                data-hide-mobileportrait="1" id="n2-ss-6-arrow-previous"
                                        ...
                                        <div class="n2-ss-slider-controls n2-ss-slider-controls-absolute-right-center">
                                            <div style="--widget-offset:15px;"
                                                ...
                                                aria-label="next arrow" tabindex="0"><img width="32"
                                                    height="32" class="n2-arrow-normal-img skip-lazy"
                                                    data-skip-lazy="1"
        ...
        <div class="is-layout-flex wp-container-10 wp-block-columns">
            <div class="is-layout-flow wp-block-column"
                ...
                <figure class="wp-block-image size-full font-be"><img decoding="async" loading="lazy" width="400"
                        height="280" src="./images/2023-03-z4161604008855_408de97e17f90eb79f557a8eebc62f05.jpg"
                        alt="" class="wp-image-590" /></figure>
            ...
            <div class="is-layout-flow wp-block-column"
                ...
                <figure class="wp-block-image size-full font-be"><img decoding="async" loading="lazy" width="445"
                        height="280" src="./images/2023-03-z4161604497852_820ff5f277d46d1af69c30e78966a7b6.jpg"
                        alt="" class="wp-image-591" /></figure>
            ...
            <div class="is-layout-flow wp-block-column"
                ...
                <figure class="wp-block-image size-full font-be"><img decoding="async" loading="lazy" width="400"
                        height="280" src="./images/2023-03-z4161604790333_5db71f717c62dea9c15f9704155c66be.jpg"
                        alt="" class="wp-image-592" /></figure>
        ...
        <div class="is-layout-flex wp-container-21 wp-block-columns">
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-flow wp-block-group">
                    <figure class="wp-block-image aligncenter size-large is-resized"><img decoding="async"
                            loading="lazy" src="./images/2023-03-money-bill-solid.svg" alt=""
                            class="wp-image-446" width="130" height="120" /></figure>
                </div>
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-flow wp-block-group">
                    <figure class="wp-block-image aligncenter size-large is-resized"><img decoding="async"
                            loading="lazy" src="./images/2023-03-pub-overview-1.svg" alt=""
                            class="wp-image-452" width="130" height="120" /></figure>
                </div>
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-flow wp-block-group">
                    <figure class="wp-block-image aligncenter size-large is-resized"><img decoding="async"
                            loading="lazy" src="./images/2023-03-circle-check-regular.svg" alt=""
                            class="wp-image-453" width="130" height="120" /></figure>
                </div>
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-flow wp-block-group">
                    <figure class="wp-block-image aligncenter size-large is-resized"><img decoding="async"
                            loading="lazy" src="./images/2023-03-pub-overview-2.svg" alt=""
                            class="wp-image-454" width="130" height="120" /></figure>
                </div>
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-flow wp-block-group">
                    <figure class="wp-block-image aligncenter size-large is-resized"><img decoding="async"
                            loading="lazy" src="./images/2023-03-graduation-cap-solid.svg" alt=""
                            class="wp-image-456" width="130" height="120" /></figure>
                </div>
        ...
        <div class="is-layout-flex wp-container-34 wp-block-columns">
            <div class="is-layout-flow wp-block-column" style="flex-basis:100%">
                <div class="is-layout-constrained wp-container-23 wp-block-group">
                    <figure class="wp-block-image size-full has-custom-border"><img decoding="async" loading="lazy"
                            ...
                            src="./images/2023-03-z4159135215716_59b8f0c99f87e36972cc7714e1fc8363-1.jpg"
                            alt="" class="wp-image-584"
                    ...
                    <p class="has-text-align-center font-be" style="font-size:16px">Bạn đang đi làm nhưng vẫn muốn có
                        thêm nguồn thu nhập mới bên cạnh nguồn thu từ công việc chính. Hãy tham gia cùng MCCANNASIA <a
                            ...
                            href="https://workspace.accesstrade.vn/authentication/register?lang=vi"
                            target="_blank"></a>
                    </p>
            ...
            <div class="is-layout-flow wp-block-column" style="flex-basis:100%">
                <div class="is-layout-constrained wp-container-26 wp-block-group">
                    <figure class="wp-block-image size-full has-custom-border"><img decoding="async" loading="lazy"
                            ...
                            src="./images/2023-03-z4159135762754_4f8f2b4a758f04e72c29761488a70618-1.jpg"
                            alt="" class="wp-image-585" style="border-radius:10px" /></figure>
                    <p class="has-text-align-center font-be" style="font-size:25px"><strong>Người chưa đi làm</strong>
                    </p>
                    <p class="has-text-align-center font-be" style="font-size:16px">Bạn là mẹ bỉm sữa, sinh viên,
                        người
            ...
            <div class="is-layout-flow wp-block-column" style="flex-basis:100%">
                <div class="is-layout-constrained wp-container-29 wp-block-group">
                    ...
                    <p class="has-text-align-center font-be" style="font-size:25px"><strong>Làm việc tự do</strong>
                    </p>
                    <p class="has-text-align-center font-be" style="font-size:16px">Bạn là freelancer đang làm công
                        việc
            ...
            <div class="is-layout-flow wp-block-column" style="flex-basis:100%">
                <div class="is-layout-constrained wp-container-32 wp-block-group">
                    ...
                    <p class="has-text-align-center font-be" style="font-size:25px"><strong>KOL/Influencer</strong>
                    </p>
        ...
        <div class="is-content-justification-center is-nowrap is-layout-flex wp-container-37 wp-block-group"
            ...
            <div class="is-content-justification-right is-layout-constrained wp-container-36 wp-block-group">
                <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="1024"
                        height="793" src="./images/2023-03-img-1-1024x793-1.png" alt=""
                        class="wp-image-484" /></figure>
            </div>
        </div>
        <p class="has-text-align-center font-be has-text-color"
            style="color:#54595f;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;font-size:20px">Khi
            giới
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-constrained wp-container-38 wp-block-group">
                    <figure class="wp-block-image alignwide size-full"><img decoding="async" loading="lazy"
                            width="161" height="175" src="./images/2023-03-1.png" alt=""
                            class="wp-image-495" /></figure>
                </div>
            ...
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-constrained wp-container-40 wp-block-group">
                    <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="155"
                            height="169" src="./images/2023-03-2.png" alt="" class="wp-image-496" />
                    </figure>
                </div>
                <p class="has-text-align-center font-roboto" style="font-size:15px">Tạo&nbsp;Link giới thiệu bạn bè
                </p>
            </div>
            <div class="is-layout-flow wp-block-column">
                <div class="is-layout-constrained wp-container-42 wp-block-group">
                    <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="162"
                            height="175" src="./images/2023-03-3.png" alt="" class="wp-image-497" />
                    </figure>
                </div>
                <p class="has-text-align-center font-roboto" style="font-size:15px">Gửi link đã tạo cho bạn bè đăng
                    ký
                ...
                <div class="is-layout-flex wp-container-52 wp-block-columns alignwide"
                    ...
                    <div class="is-layout-flow wp-block-column">
                        <figure class="wp-block-image size-full is-resized"><img decoding="async" loading="lazy"
                                src="./images/LOGO1.png" alt="" class="wp-image-372" width="162"
                                height="47" />
                        </figure>
                        <p class="font-be has-background-color has-text-color" style="font-size:15px">Giấy phép ĐKKD
                            số
                            0311614186 do Sở KH &amp; ĐT cấp ngày 10/03/2012.</p>
                        <p class="font-be has-background-color has-text-color" style="font-size:15px">Giấy phép MXH
                            số
                            194/GP-BTTTT ký ngày 21/05/2019.</p>
                        <p class="font-be has-background-color has-text-color" style="font-size:15px">© 2012-2022
                            Mccann
                    ...
                    <div class="is-layout-flow wp-block-column">
                        ...
                        <div class="is-layout-flex wp-block-group"><i class="fas fa-phone-alt footer-icon"></i>
                            <p class="font-be has-background-color has-text-color" style="font-size:15px">0363760703
                            </p>
                        </div>
                        <div class="is-layout-flex wp-block-group"><i class="far fa-envelope footer-icon"></i>
                            <p class="font-be has-background-color has-text-color" style="font-size:15px">
                                hotro.mccann@gmail.com</p>
                        </div>
                        <div class="is-layout-flex wp-block-group"><i class="fas fa-business-time footer-icon"></i>
                            <p class="font-be has-background-color has-text-color" style="font-size:15px">8h00-17h30
                            </p>
                        </div>
                    </div>
                    <a href="{{ asset('files/tos.pdf') }}">
                        <div class="is-layout-flow wp-block-column">
                            <p class="font-be has-luminous-vivid-amber-color has-text-color"
    ...
    <div id="pum-309"
        class="pum pum-overlay pum-theme-329 pum-theme-329 popmake-overlay pum-click-to-close click_open"
