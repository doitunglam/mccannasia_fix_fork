...
use Goeasyapp\Core\Http\Hooks\NewItemHook;
use Goeasyapp\Core\Http\Repositories\NewItemRepository;
...
class NewItemController extends Controller
{
    ...
    private $configs;
    private $model;
    public function __construct(NewItemHook $LoginValidateHook, NewItemRepository $UserRepository)
    {
