            ...
            <a-col :lg="6" :md="12" :sm="24">
                ...
                <a-form-item :label="$t('name')">
                    <a-row class="form-row">
                        ...
                        <a-col :lg="24" :md="24" :sm="24">
                            <a-form-item >
                                <a-button htmlType="submit" @click="send">Add language</a-button>
                            </a-form-item>
                        </a-col>
...
export default {
    ...
    methods: {
        ...
        send() {
            this.data.value= JSON.stringify(this.value);
            this.data.page_value= JSON.stringify(this.page_value);
