module.exports = {
  messages: {
    ...
    VN: {
      pageDesc: 'Điền thông tin cơ bản.',
      title: 'Tiêu đề',
      titleInput: 'Hãy nhập tên mục tiêu',
      date: 'Ngày bắt đầu và kết thúc',
      describe: 'Mô tả mục tiêu',
      describeInput: 'Hãy nhập mục tiêu công việc của bạn',
      metrics: 'Tiêu chuẩn đánh giá',
      metricsInput: 'Hãy nhập tiêu chuẩn đánh giá',
      customer: 'Khách hàng',
      customerInput: 'Hãy mô tả dịch vụ của bạn cho khách hàng, khách hàng nội bộ trực tiếp @ Tên / số công việc',
      critics: 'Người được mời đánh giá',
      criticsInput: 'Hãy trực tiếp @ Tên / số công việc, bạn có thể mời tối đa 5 người',
      weight: 'Cân nặng',
      disclosure: 'Thông tin mục tiêu được chia sẻ',
      disclosureDesc: 'Khách hàng và người được mời được chia sẻ mặc định',
      public: 'Công khai',
      partially: 'Công khai một phần',
      private: 'Riêng tư',
      submit: 'Gửi đi',
      save: 'Lưu lại',
      colleague1: 'Người A',
