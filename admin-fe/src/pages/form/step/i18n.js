module.exports = {
  messages: {
    ...
    VN: {
      pageDesc: 'Chia một nhiệm vụ biểu mẫu dài hoặc không quen thuộc thành nhiều bước để hướng dẫn người dùng hoàn thành nó.',
      input: 'Vui lòng điền thông tin chuyển khoản',
      confirm: 'Xác nhận thông tin chuyển khoản',
      complete: 'Hoàn thành',
      payment: 'Tài khoản thanh toán',
      collection: 'Tài khoản thu',
      alipay: 'Alipay',
      wechat: 'Wechat',
      collectionName: 'Tên người nhận',
      transferAmount: 'Số tiền chuyển',
      nextStep: 'Tiếp theo',
      preStep: 'Quay lại',
      submit: 'Gửi đi',
      note: 'Sau khi xác nhận chuyển khoản, tiền sẽ được chuyển trực tiếp vào tài khoản của bên thứ ba và không thể hoàn lại.',
      success: 'Thanh toán thành công',
      doAgain: 'Thực hiện lại',
      bill: 'Kiểm tra hóa đơn'
    }
  }
}